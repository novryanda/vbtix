...
export interface Database {
    public: {
        Tables: {
            ...
            events: {
                Row: {
                    ...
                    start_date: string
                    end_date: string
                    status: 'DRAFT' | 'PENDING_REVIEW' | 'PUBLISHED' | 'REJECTED' | 'COMPLETED' | 'CANCELLED'
                    created_at: string
                    updated_at: string
                }
                Insert: {
        ...
        Enums: {
            ...
            event_status: 'DRAFT' | 'PENDING_REVIEW' | 'PUBLISHED' | 'REJECTED' | 'COMPLETED' | 'CANCELLED'
            payment_status: 'PENDING' | 'SUCCESS' | 'FAILED' | 'EXPIRED' | 'REFUNDED'
            approval_status: 'PENDING' | 'APPROVED' | 'REJECTED'
            ticket_status: 'ACTIVE' | 'USED' | 'CANCELLED' | 'EXPIRED' | 'REFUNDED'
            withdrawal_status: 'PENDING' | 'PROCESSING' | 'COMPLETED' | 'CANCELLED' | 'FAILED'
            discount_type: 'PERCENTAGE' | 'FIXED_AMOUNT'
        }
        CompositeTypes: {
            [_ in never]: never
